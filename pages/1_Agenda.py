...
df_o_edit = st.data_editor(df_o_at, column_config={"dia": st.column_config.TextColumn("Dia da Semana", disabled=True), "data": st.column_config.TextColumn("Data", disabled=True), "observacao": st.column_config.TextColumn("Observação", width="large")}, hide_index=True, width='stretch', row_height=100, key="ed_obs_oficial_aurav2")
...
# 5. GERENCIADOR DE STATUS (OCULTAR / CANCELAR)
...
# 6. FILTRAGEM DOS PASSAGEIROS E TRATAMENTO DE ACENTOS
...
# 7. CONSTRUÇÃO SEGURA DO RELATÓRIO EM HTML/PDF COM FOLHA DE ESTILO
...
# CSS idêntico ao original, montado em partes para o servidor não quebrar as aspas
relatorio_css = (
    "<style>"
...
# 8. EXIBIÇÃO DAS TABELAS NA TELA COM OS HEADERS AZUIS DA AURA
