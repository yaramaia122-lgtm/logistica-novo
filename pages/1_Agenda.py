...
# 🌟 CAMPO DE OBSERVAÇÕES EM CAIXA DE TEXTO MULTILINHA (TEXT_AREA)
st.markdown('<div class="section-header">Observações Semanais Operacionais</div>', unsafe_allow_html=True)
st.info("Digite as atividades abaixo. Você pode pressionar ENTER diretamente para quebrar linhas.")
...
if st.button("Atualizar Status do Registro Selecionado", width='stretch'):
    if v_sel:
        ...
        rp.update_file("dados_logistica.csv", "Status Update", df_v
